...
// POST /api/leads — public, rate-limited to prevent lead-form spam
...
// GET /api/leads/admin/all — protected, never rate-limited
...
// DELETE /api/leads/:id — protected, never rate-limited

...
const cards = [
    {
        number: "01",
        title: "Publications",
        description: "Read our latest business insights, reports, and expert articles.",
    ...
    },
    {
        number: "02",
        title: "Library",
        description: "Access practical tools, guides, and templates to boost your business efficiency.",
    ...
    },
    {
        number: "03",
        title: "Form",
        description: "Download essential compliance, registration, and finance forms instantly.",
                    ...
                    {cards.map((card, i) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-[#0d1e4a] to-transparent" />
                            </div>

...
const blogs = [
  {
    ...
    excerpt: "Council tax, a local taxation system in the UK, can sometimes become a...",
    path: "/blogs/council-tax-arrangement-plan",
  },
  {
    title: "Self-Assessment Tax Return Process for Businesses: Navigating the Complexity",
    excerpt: "Welcome to de tempête, where we simplify the intricate world of tax return...",
    path: "/blogs/self-assessment-tax-return",
  },
  {
    title: "The Role and Benefits of a Virtual CFO in Modern Businesses",
    excerpt: "Welcome to de tempête, where we redefine financial management for the modern business...",
            ...
            >
              ...
              */}
              <div
                ...
                style={{ background: "linear-gradient(160deg, #b0bec5 0%, #0d1e4a 100%)" }}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0d1e4a]/90 via-[#0d1e4a]/20 to-transparent" />
            ...
            <div className="flex flex-col gap-3">
              {blogs.map((blog) => (
                ...
                >
                  ...
                  <div className="shrink-0 rounded-lg overflow-hidden" style={{ width: "88px", height: "72px" }}>
                    <div className="w-full h-full bg-gradient-to-br from-[#1a9fd4]/20 to-[#0d1e4a]/30 flex items-center justify-center">
                      <svg className="w-6 h-6 text-[#1a9fd4]/50" fill="none" viewBox="0 0 24 24" stroke="currentColor">

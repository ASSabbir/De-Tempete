...
const services = [
    ...
    icon: (
      ...
      >
        ...
        <circle
          ...
          strokeWidth="1.2"
        />
        <text x="29" y="23" fontSize="6" fill="#1a9fd4" fontWeight="bold">
          $
        </text>
      </svg>
    ),
  },
  {
    ...
    icon: (
      ...
      >
        ...
        <text x="10" y="25" fontSize="5" fill="white" fontWeight="bold">
          $
        </text>
      </svg>
    ),
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M32 8 C20 8 14 18 14 28 C14 40 24 52 32 56 C40 52 50 40 50 28 C50 18 44 8 32 8Z"
          fill="#e0f2fe"
          stroke="#1a9fd4"
          strokeWidth="1.2"
        />
        <text x="27" y="34" fontSize="14" fill="#1a9fd4" fontWeight="bold">
          $
        </text>
  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        <text x="31" y="41" fontSize="7" fill="#1a9fd4" fontWeight="bold">
          $
        </text>
      </svg>
    ),
  },
  {
    ...
    icon: (
      ...
      >
        ...
        />
        <path
          d="M10 32 Q4 28 8 22 Q16 18 21 22"
          strokeLinecap="round"
          fill="#e0f2fe"
        />
        <rect x="28" y="10" width="20" height="10" rx="5" fill="#1a9fd4" />
        <text x="30" y="18" fontSize="7" fill="white" fontWeight="bold">
          HIRING!
        </text>
    ...
    icon: (
      ...
      >
        <circle
          ...
          strokeWidth="1.2"
        />
        <text x="28" y="48" fontSize="10" fill="#1a9fd4" fontWeight="bold">
          $
        </text>
        <path
          d="M22 30 Q18 20 26 14 Q32 10 38 14 Q46 20 42 30"
          fill="#e0f2fe"
          stroke="#0d1e4a"
        />
  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        <polyline
          points="14,36 24,24 32,30 42,18 50,22"
          strokeLinecap="round"
          strokeLinejoin="round"
          stroke="#1a9fd4"
          strokeWidth="2"

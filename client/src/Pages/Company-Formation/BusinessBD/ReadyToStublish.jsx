    ...
    <section className="relative overflow-hidden bg-linear-to-r from-[#081B57] to-[#57D3EB] py-24">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white">
        ...
        <h3 className="text-3xl md:text-4xl 2xl:text-5xl font-light mt-2">
          Your Presence In The Bangladesh?
        </h3>
        ...
        <p className="mt-8 text-base leading-8 text-gray-100 max-w-3xl mx-auto">
          ...
          Bangladesh business setup consultants ensure your company is fully
          compliant and ready to grow.
        </p>

        <div className="my-10">
          <SharedButton text={' Start Your Bangladesh Business Today'} path={'/business-setup/bd#bussiness-setup-bd'}></SharedButton>
        </div>
      </div>

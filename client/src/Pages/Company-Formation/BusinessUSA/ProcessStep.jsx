...
const steps = [
  ...
  {
    title: "Step 04",
    desc: "Prepare the Operating Agreement & company records.",
  },
  {
    title: "Step 05",
...
const ProcessStep = () => {
  return (
    <section className="bg-[#ffffff] overflow-hidden pt-20">
      <div className="max-w-7xl mx-auto px-6">
        {/* Heading */}
        <div className="max-w-5xl mb-24">
          <h2 className="text-[#000000] text-4xl 2xl:text-5xl font-light leading-tight">
            Step-By-Step Process For
            
            USA <br/> <span className="font-bold">Company Registration</span>
          </h2>

          <p className="text-gray-600 mt-6 text-base">
            Setting up a business in the USA involves a few streamlined steps
          </p>
        </div>
        ...
        <div className="hidden lg:block relative h-[650px]">
          ...
          {steps.map((step, index) => (
            <div
              key={index}
              className={`absolute w-[240px] text-center ${positions[index]}`}
            >
              {/* Icon */}

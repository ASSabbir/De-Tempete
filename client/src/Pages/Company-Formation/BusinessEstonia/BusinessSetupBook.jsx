import img1 from '../../../asstes/img_temp/estoniabook.webp'
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-8 text-xl text-[#4B5563] leading-7">
              Your quick guide to starting and growing a business in the Bangladesh.
            </p>

            <div className=" text-[#14224A] text-base">
              <p className="font-bold">
                The Estonia Business Setup Guide 2026
              </p>

              <p>
                <span className="font-bold">Download</span> our Full Bangladesh
            ...
            <DownloadButtonGuide guideKey="estonia-guide-2026" label="Download Now"></DownloadButtonGuide>
          </div>

  ...
  return (
    <section className="bg-[#F5F5F5] py-20">
      <div className="max-w-5xl 2xl:max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        {/* Left Content */}
        <div>
          <h2 className="text-[#14224A] text-3xl md:text-4xl 2xl:text-5xl font-light leading-tight">
            Why Start A
            <br />
            <span className="font-bold">Business In The UAE?</span>
          </h2>

          <p className="mt-8 text-[#39425B] text-sm md:text-base text-justify">
        ...
        {/* Right Cards */}
        <div className="grid grid-cols-2 gap-5 text-base md:text-xl">

...
const ReadyToStublish = () => {
  return (
    <section className="relative overflow-hidden bg-linear-to-r from-[#081B57] to-[#57D3EB] py-24">
      {/* Main Content */}
      <div className="relative z-10 mb-10 max-w-4xl mx-auto px-6 text-center text-white">
        <h2 className="text-3xl md:text-4xl 2xl:text-5xl font-bold leading-tight">
          Ready To Establish
        </h2>

        <h3 className="text-3xl md:text-4xl 2xl:text-5xl font-light mt-2">
          Your Presence In The UAE?
        </h3>

        <p className="mt-8 mb-10 text-base leading-8 text-gray-100 max-w-3xl mx-auto">
        ...
        <SharedButton path={'/business-setup/uae#bussiness-setup-uae'} text={'Start Your UAE Business Today'}></SharedButton>
      </div>

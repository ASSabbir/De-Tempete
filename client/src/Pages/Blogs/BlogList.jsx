              ...
              {items.map((blog) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-lg font-bold text-[#16244b] leading-snug mb-3 group-hover:text-cyan-500 transition-colors">
                      {blog.title}
                    </h3>
                    <p className="text-gray-500 text-sm leading-6 line-clamp-3">
                      {blog.description}
                    </p>
                    <span className="inline-block mt-4 text-cyan-500 font-semibold text-sm">
                      Read More →
                    </span>
                  </div>
                </Link>
          ...
          {!loading && pages > 1 && (
            <div className="flex items-center justify-center gap-2 mt-16">
              <button
                ...
                disabled={page === 1}
                className="px-4 py-2 rounded-lg border border-gray-200 text-gray-500 disabled:opacity-40 hover:border-cyan-300 transition-colors"
              >
                Prev
              </button>

...
const whyChoose = [
  { title: "UAE-Focused Expertise", desc: "Deep understanding of local regulations and compliance requirements." },
  { title: "Global Experience", desc: "Practical solutions for cross-border and multinational operations." },
  { title: "Risk Minimization", desc: "Proactive strategies to reduce penalties and financial exposure." },
  { title: "Tailored Solutions", desc: "Customized tax planning for startups, SMEs, and large corporates." },
];
  ...
  return (
    <div className="w-full">
      ...
      <section className="pt-40 pb-24 relative min-h-screen flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-6 text-center">
          <h1 className="text-5xl md:text-7xl font-bold leading-tight">
            ...
            <br />
            <span className="text-[#4AC4DE]">Taxes In The UAE</span>
          </h1>
          <p className="max-w-4xl mx-auto mt-8 text-lg md:text-2xl text-gray-200 leading-relaxed">
            Expert Corporate Tax, VAT & Transfer Pricing Solutions for Seamless Compliance and Growth
          </p>
        ...
        <div className="max-w-8xl mx-auto px-30">
          <div className="grid lg:grid-cols-5 gap-10 items-center">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <h3 className="text-[#14224A] text-4xl font-bold"><AnimatedCounter end={1001} duration={2500} />+</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1600px] mx-auto px-6 grid lg:grid-cols-2 gap-16 items-stretch">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl font-bold text-[#16244b]">Corporate <span className="font-light">Tax Advisory</span></h2>
            <p className="mt-5 text-gray-500 leading-7">
              Take control of your corporate tax obligations in the UAE with expert guidance. We provide strategic
              planning, compliance support, and optimization to ensure your business meets regulations while
              minimizing tax liabilities.
            </p>
            <h4 className="mt-6 mb-4 italic font-bold text-[#16244b]">Benefits:</h4>
            <div className="space-y-3">
              {["Accurate corporate tax calculation and planning", "Minimized risk of penalties and audits", "Tailored strategies for startups, SMEs, and corporates"].map((item, i) => (
      ...
      <section className="py-12 bg-white">
        <div className="max-w-[1600px] mx-auto px-6 grid lg:grid-cols-2 gap-16 items-stretch">
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl font-bold text-[#16244b]">VAT <span className="font-light">Advisory</span></h2>
            <p className="mt-5 text-gray-500 leading-7">
              Simplify VAT compliance with our end-to-end advisory services. From registration to filings and
              audits, we help businesses navigate UAE VAT regulations efficiently and accurately.
            </p>
            <h4 className="mt-6 mb-4 italic font-bold text-[#16244b]">Benefits:</h4>
            <div className="space-y-3">
              {["Complete VAT registration support", "Timely VAT filing and reporting", "Risk reduction and compliance assurance"].map((item, i) => (
                <div key={i} className="flex items-center gap-3">
                  <FaCheckCircle className="text-cyan-400 text-lg flex-shrink-0" />
                  <span className="text-gray-600">{item}</span>
                </div>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-[1600px] mx-auto px-6 grid lg:grid-cols-2 gap-16 items-stretch">
          ...
          />
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl font-bold text-[#16244b]">Excise Tax <span className="font-light">Advisory</span></h2>
            <p className="mt-5 text-gray-500 leading-7">
              Stay compliant with UAE excise tax laws while optimizing your business costs. Our advisory ensures
              proper classification, filing, and planning to avoid unnecessary penalties and improve financial
              efficiency.
            </p>
            <h4 className="mt-6 mb-4 italic font-bold text-[#16244b]">Benefits:</h4>
            <div className="space-y-3">
              {["Accurate excise tax calculation and reporting", "Guidance on excisable goods and compliance", "Reduce liabilities and avoid regulatory issues"].map((item, i) => (
                <div key={i} className="flex items-center gap-3">
                  <FaCheckCircle className="text-cyan-400 text-lg flex-shrink-0" />
                  <span className="text-gray-600">{item}</span>
                </div>
        ...
        <div className="max-w-[1600px] mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl font-light text-white">
              Transfer <span className="font-bold">Pricing & Cross-Border Tax</span> Support
            </h2>
            <p className="mt-6 text-slate-300 leading-7">
              Ensure your international operations are fully compliant with UAE and global tax laws. We provide
              transfer pricing analysis, documentation, and cross-border advisory to optimize your global
              transactions.
            </p>
        ...
        <div className="max-w-[1600px] mx-auto px-6">
          <div className="text-center">
            <h2 className="text-4xl font-light text-[#16244b]">
              Why Choose Our <span className="font-bold">Taxation Services?</span>
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-5xl leading-tight font-light text-white">
                Ready To Simplify Your<br />Taxes In The <span className="font-bold">UAE?</span>
              </h2>
              <p className="mt-8 text-cyan-400 text-xl font-semibold leading-9 max-w-xl">
                Partner with de tempête and take control of your corporate, VAT, excise, and cross-border tax

...
import { LuTarget, LuChartLine, LuShieldCheck, LuTriangleAlert, LuHandshake, LuFlag } from "react-icons/lu";
...
const setupTypes = [
  { title: "Mainland", image: "/src/asstes/Images/servics/UK/Global-business-strategy-in-focus.webp", items: ["100% foreign ownership", "Full UAE market access", "Physical office required", "Local sponsor required", "9% corporate tax", "5% VAT applicable", "Residence visa eligibility"] },
  { title: "Free Zone", image: "/src/asstes/Images/servics/freepik__hr-outsourcing-image-for-website-section__98146.webp", items: ["0% corporate tax", "Full foreign ownership", "Zone-restricted activities", "Office space required", "Annual audit required", "Residence visa eligibility", "VAT conditional rules"] },
  { title: "Offshore", image: "/src/asstes/Images/servics/UK/UK-tax-compliance-workspace-concept.webp", items: ["Asset Protection", "Tax efficiency", "Quick setup process", "No UAE office", "No residence visa", "No minimum capital", "Audit not mandatory"] },
];

const goToMarket = [
  { icon: LuTarget, title: "Target Market & Competitive Analysis", desc: "Assess market size, trends, demand potential, and your competitive positioning." },
  { icon: LuChartLine, title: "Financial & ROI Modelling", desc: "Develop detailed financial projections — income, costs, profitability — and evaluate returns versus investments." },
  { icon: LuShieldCheck, title: "Regulatory & Operational Readiness", desc: "Examine statutory, legal, and operational factors to ensure smooth market entry and execution." },
  { icon: LuTriangleAlert, title: "Risk & Sensitivity Assessment", desc: "Identify risks and analyse how different scenarios could impact success." },
  { icon: LuFlag, title: "Business Model Localisation", desc: "Adapt your pricing, offering, and structure to align with UAE market behavior and regulations." },
  { icon: LuHandshake, title: "Partnerships & Distribution Planning", desc: "Identify potential local alliances and optimal routes to market." },
];

const exportItems = [
  { title: "Assessing Your Export Readiness Before You Expand", desc: "Evaluate your operational, financial, and logistical readiness before entering export markets." },
  { title: "Navigating Trade Regulations and Legal Requirements", desc: "Understand and comply with UAE and international trade regulations." },
  { title: "Building Risk Management and Due Diligence Frameworks", desc: "Establish frameworks to identify and mitigate cross-border trade risks." },
  { title: "Optimizing Documentation, Customs and Logistics Processes", desc: "Streamline documentation, customs clearance, and logistics operations." },
  { title: "Creating Sustainable Export Systems for Long-Term Growth", desc: "Build scalable export systems that support long-term international growth." },
];

const visaCards = ["Investor & Partner Visa Processing", "Dependent Visa Sponsorship", "Emirates ID & Medical Coordination", "Visa Renewals And Compliance"];

const whyChoose = [
  { title: "Accurate and up-to-date financial records", desc: "Lorem ipsum is simply dummy text of the printing and typesetting industry." },
  { title: "End-to-end support — from setup to residency", desc: "Deep knowledge of UAE business, legal & banking landscape." },
  { title: "Tailored solutions for startups, SMEs & global investors", desc: "Deep knowledge of UAE business, legal & banking landscape." },
  { title: "Transparent processes and ongoing compliance focus", desc: "Deep knowledge of UAE business, legal & banking landscape." },
];
      ...
      <section className="pt-40 pb-24 relative min-h-screen flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-6 text-center">
          <h1 className="text-5xl md:text-7xl font-bold leading-tight">
            ...
            <br />
            <span className="text-[#4AC4DE]">Establish Your Business Presence</span>
            <br />
            In The UAE The Right Way
          </h1>
          <p className="max-w-4xl mx-auto mt-8 text-lg md:text-2xl text-gray-200 leading-relaxed">
            The UAE continues to stand as the region's most attractive hub for global trade, investment, and
            innovation. Whether you're an international company entering the GCC market or a local business ready to
            scale, our Market Expansion & Setup Advisory services help you navigate every step — from strategy to
            execution, with clarity, compliance and confidence.
          </p>
        ...
        <div className="max-w-[1600px] mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-5xl font-bold text-[#13264d]">
              Business Setup & <span className="font-extrabold">Registration</span>
            </h2>
            <p className="mt-5 text-gray-500 font-semibold">
              From entry formation to licensing, we simplify every stage of your UAE business setup.
            </p>
            <p className="mt-7 text-lg text-gray-600 leading-8">
              Our experts help you choose the right jurisdiction — Mainland, Free Zone, or Offshore — based on your
              ownership goals, industry type, and target market.
            </p>
          </div>
            ...
            {setupTypes.map((item, index) => (
              <div key={index} className="bg-white rounded-3xl overflow-hidden shadow-lg border border-gray-200 hover:-translate-y-2 hover:shadow-2xl duration-300">
                <div className="relative h-48 overflow-hidden">
                  ...
                  <h3 className="absolute bottom-5 left-24 text-white text-2xl font-bold">{item.title}</h3>
                </div>
                <div className="p-8">
                  <ul className="space-y-4">
                    {item.items.map((text, i) => (
                      <li key={i} className="flex items-start gap-4 text-gray-600 leading-7">
        ...
        <div className="max-w-[1600px] mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-light text-[#16244b]">
              <span className="font-bold">Go-To-Market</span> Strategy & Business Model Localisation
            </h2>
            <p className="mt-6 text-gray-500 leading-7">
              Success in the UAE market requires more than just registering a company, it requires understanding
              local culture, consumer behavior, and business dynamics. We help you tailor your business model,
              pricing, and operations to fit the UAE's regulatory and commercial landscape.
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-2">
              Export Readiness, Trade <span className="block">Compliance & Logistics Advisory</span>
            </h2>
            <p className="text-gray-500 mt-4 max-w-2xl mx-auto text-sm">
              We guide businesses on export licensing, customs documentation, and supply chain optimisation, ensuring
              your trade operations run smoothly across UAE borders.
            </p>
          </div>
        ...
        <div className="max-w-[1600px] mx-auto px-6 space-y-16">
          <div className="grid lg:grid-cols-2 gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-center">
              <h2 className="text-3xl font-bold text-[#16244b]">Bank Account <span className="font-light">Opening Assistance</span></h2>
              <p className="mt-5 text-gray-500 leading-7">
                We coordinate with leading local and international banks to help you open and activate your account
                efficiently.
              </p>
              <h4 className="mt-6 mb-4 italic font-bold text-[#16244b]">Our team handles:</h4>
              <div className="space-y-3">
                {["Bank selection and eligibility guidance", "Compliance documentation and submission", "End-to-end coordination until account activation"].map((item, i) => (
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-stretch">
            <div className="flex flex-col justify-center">
              <h2 className="text-3xl font-bold text-[#16244b]">Trademark <span className="font-light">Registration & IP Protection</span></h2>
              <p className="mt-5 text-gray-500 leading-7">
                We assist in trademark and intellectual property registration through the UAE Ministry of Economy —
                ensuring your brand, logo and products are legally safeguarded.
              </p>
              <h4 className="mt-6 mb-4 italic font-bold text-[#16244b]">Our support includes:</h4>
              <div className="space-y-3">
                {["Trademark search and registration", "Patent and copyright advisory", "IP renewal and protection strategy"].map((item, i) => (
                  <div key={i} className="flex items-center gap-3">
                    <FaCheckCircle className="text-cyan-400 text-lg flex-shrink-0" />
                    <span className="text-gray-600">{item}</span>
                  </div>
        ...
        <div className="max-w-[1600px] mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-4xl font-light text-white">
              Investor <span className="font-bold">Visa & UAE Residency</span> Support
            </h2>
            <p className="mt-6 text-slate-300 leading-7">
              Secure your place in the UAE with seamless investor and residency visa assistance. Our specialists
              manage all documentation and applications for smooth visa processing for investors, employees, and
              dependents. Services include:
            </p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-[1600px] mx-auto px-6">
          <div className="text-center">
            <h2 className="text-4xl font-light text-[#16244b]">
              Why Choose Our <span className="font-bold">UAE Market Expansion Advisory</span>
            </h2>

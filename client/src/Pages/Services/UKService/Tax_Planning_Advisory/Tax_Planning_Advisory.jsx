    ...
    <div className="w-full">
        ...
        <div className="max-w-8xl mx-auto px-2">
          <div className="grid lg:grid-cols-5 gap-10 items-center">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <h3 className="text-[#14224A] text-4xl font-bold"><AnimatedCounter end={927} duration={2500} />+</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h2 className="text-4xl leading-tight text-[#16244b] font-light">
            <span className="font-bold">Corporate Tax Planning</span> & Compliance
          </h2>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="h-[300px] bg-gradient-to-br from-slate-100 to-slate-300 rounded-2xl"></div>
        </div>
      </section>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div className="h-[300px] bg-gradient-to-br from-amber-100 to-amber-300 rounded-2xl"></div>
          <div>
            <h2 className="text-3xl font-bold text-[#16244b]">Capital Gains Tax <span className="font-light">(CGT) Advisory</span></h2>
            <p className="mt-5 text-gray-500 font-semibold">Keep more of what you earn.</p>
            <p className="mt-3 text-gray-500 leading-7">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl font-bold text-[#16244b]">Inheritance <span className="font-light">Tax Planning</span></h2>
            <p className="mt-5 text-gray-500 font-semibold">Secure your assets for the next generation.</p>
            <p className="mt-3 text-gray-500 leading-7">
          ...
          <div className="h-[300px] bg-gradient-to-br from-stone-100 to-stone-300 rounded-2xl"></div>
        </div>
      </section>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div className="h-[300px] bg-gradient-to-br from-orange-100 to-orange-300 rounded-2xl"></div>
          <div>
            <h2 className="text-3xl font-bold text-[#16244b]">R&D Tax <span className="font-light">Credit Claims</span></h2>
            <p className="mt-5 text-gray-500 font-semibold">Claim what you're eligible for, without complexity.</p>
            <p className="mt-3 text-gray-500 leading-7">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl font-bold text-[#16244b]">HMRC Investigation <span className="font-light">Support & Dispute Resolution</span></h2>
            <p className="mt-5 text-gray-500 font-semibold">Expert support to resolve disputes quickly and compliantly.</p>
            <p className="mt-3 text-gray-500 leading-7">
          ...
          <div className="h-[300px] bg-gradient-to-br from-blue-100 to-blue-300 rounded-2xl"></div>
        </div>
      </section>

...
import { LuChartNoAxesCombined, LuBuilding2, LuLineChart, LuWallet, LuFileSearch } from "react-icons/lu";
...
const valuationCards = [
  { icon: LuBuilding2, title: "Business Valuation", desc: "Accurate valuation reports based on financial performance, market conditions, and future projections." },
  { icon: LuLineChart, title: "Investment Feasibility Analysis", desc: "Evaluate potential investments to ensure profitability and strategic alignment." },
  { icon: LuWallet, title: "ROI Forecasting", desc: "Project returns to make confident, data-driven financial decisions." },
  { icon: LuFileSearch, title: "Investor Readiness Support", desc: "Pitch decks, financial models, and due diligence preparation." },
];

const maItems = [
  { title: "M&A Strategy & Due Diligence", desc: "Identify acquisition targets and assess risk through thorough due diligence." },
  { title: "Deal Structuring & Negotiation", desc: "Structure deals that protect value and align with your strategic goals." },
  { title: "Business Restructuring Advisory", desc: "Reorganise operations and structure for efficiency and long-term growth." },
  { title: "Post-Merger Integration", desc: "Ensure smooth integration of teams, systems, and operations after a merger." },
];

const financialGrowth = [
  { title: "Financial Forecasting & Planning", desc: "Clear Projections To Guide Decision-Making And Investment." },
  { title: "Profitability Analysis", desc: "Identify Strengths, Reduce Inefficiencies, And Improve Margins." },
  { title: "Growth & Expansion Strategy", desc: "Structured Plans To Scale Into New Markets Or Product Lines." },
  { title: "Risk Management Advisory", desc: "Assess Vulnerabilities And Build Strategies That Protect Your Business." },
];
    ...
    <div className="w-full">
      ...
      <section className="pt-40 pb-24 relative min-h-screen flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <h1 className="text-5xl md:text-7xl font-bold leading-tight">
            Strategic Business
            <br />
            <span className="text-[#4AC4DE]">Advisory For Confident Decisions</span>
            <br />
            & Sustainable Growth
          </h1>
          <p className="max-w-4xl mx-auto mt-8 text-lg md:text-2xl text-gray-200 leading-relaxed">
            From formation to expansion, valuation to exit strategies—our advisory solutions help businesses
            navigate challenges, unlock opportunities, and grow with clarity and confidence.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="mt-3 text-lg leading-8 text-gray-500">
              We guide startups, SMEs, and investors through every step of company formation, ensuring compliance,
              efficiency, and the right structure for long-term success.
            </p>
            <h4 className="mt-6 mb-4 italic font-bold text-[#16244b]">Key Points:</h4>
            <div className="space-y-3">
              {["Entity selection & structuring", "Licensing & registration", "Compliance and documentation", "Market entry advisory"].map((item, i) => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h2 className="text-4xl leading-tight text-[#16244b] font-light">
            <span className="font-bold">Business Valuation</span> & Investment Advisory Localisation
          </h2>
          <p className="mt-6 text-lg leading-8 text-gray-500 font-semibold">
            Know Your Worth. Make Smarter Investment Decisions.
          </p>
          <p className="mt-3 text-lg leading-8 text-gray-500">
            Our valuation and investment advisory services help you understand the true financial position of your
            business, attract investors, and make informed strategic decisions.
          </p>
        </div>
          ...
          {valuationCards.map((c, i) => {
            ...
            return (
              <div key={i} className="text-center">
                ...
                <h3 className="text-lg font-bold text-[#16244b] mb-2">{c.title}</h3>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-2">
              Mergers, Acquisitions & <span className="block">Restructuring Support</span>
            </h2>
            ...
            <p className="text-gray-500 mt-2 max-w-2xl mx-auto text-sm">
              Whether you're merging, acquiring, or restructuring operations, our advisors ensure a smooth,
              compliant, and strategic transition.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="mt-3 text-lg leading-8 text-gray-500">
              We help business owners prepare for a successful transition, whether you're selling, retiring, or
              passing the business to the next generation.
            </p>
            <h4 className="mt-6 mb-4 italic font-bold text-[#16244b]">Key Points</h4>
            <div className="space-y-3">
              {["Exit Strategy Development", "Succession Planning", "Valuation & Deal Advisory", "Legal & Compliance Guidance"].map((item, i) => (
                <div key={i} className="flex items-center gap-3">
                  <FaCheckCircle className="text-cyan-400 text-lg flex-shrink-0" />
                  <span className="text-gray-600">{item}</span>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <p className="mt-8 text-xl text-slate-300 leading-9 max-w-4xl mx-auto">
              <span className="font-semibold text-white">Build a Financial Strategy That Drives Growth</span><br />
              We create actionable financial strategies that enhance profitability, strengthen cash flow, and
              support sustainable business expansion.
            </p>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mt-20">
            {financialGrowth.map((item, index) => (
              <div key={index} className="bg-[#39446B] border border-white/10 rounded-2xl py-10 px-6 text-center transition-all duration-300 hover:-translate-y-2 hover:bg-[#43507d] hover:shadow-2xl">
                ...
                <h3 className="mt-8 text-lg font-bold text-white leading-relaxed">{item.title}</h3>
                <p className="mt-3 text-slate-300 text-sm leading-6">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-5xl leading-tight font-light text-white">
                Make Smarter Business<br />Decisions <span className="font-bold">Today</span>
              </h2>
              <div className="mt-10 bg-[#37456B] rounded-2xl p-8 max-w-xl">
                <p className="text-gray-200 text-lg">
                  Get expert guidance to build, scale, or exit your business with confidence.
                </p>
                <p className="mt-4 text-cyan-400 font-bold text-lg">Talk to Our Business Advisors</p>
              </div>
            </div>

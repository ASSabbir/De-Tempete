...
const payrollPoints = [
  ...
  "Employee compensation coordination",
  "Payslip preparation support",
  "Workforce data organization",
  "Payroll reporting assistance",
];

const qiwaPoints = [
  "Qiwa coordination support",
  "GOSI documentation assistance",
...
const empDocPoints = [
  ...
  "Staff onboarding coordination",
  "Attendance & leave tracking",
  "Workforce administration support",
];

const gains = [
  "Organized Workforce Operations",
  "Improved Payroll Accuracy",
  "Better HR Documentation",
  "Stronger Compliance Coordination",
...
const whyChoose = [
  {
    title: "KSA Workforce Compliance Understanding",
    desc: "Support aligned with Saudi workforce regulations and operational requirements.",
  },
  {
    title: "Organized Payroll Operations",
    desc: "Helping businesses maintain structured payroll and employee management systems.",
  },
  {
    title: "Efficient HR Administration",
    desc: "Improving workforce coordination and operational efficiency.",
  },
  {
    title: "Scalable Business Support",
    desc: "Flexible HR and payroll solutions for startups, SMEs, and growing enterprises.",
  },
  {
    title: "Structured Workforce Processes",
    desc: "Supporting smoother employee management and documentation workflows.",
  },
  {
    title: "Long-Term Operational Stability",
    desc: "Building HR systems that support sustainable business growth.",
  },
];

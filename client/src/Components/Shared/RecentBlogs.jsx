...
export const RecentBlogs = ({ limit = 3 }) => {
  ...
  useEffect(() => {
    API.get(`/news-events/recent?limit=1`)
      .then(({ data }) => setNewsItem(data?.[0] || null))
      .catch(() => setNewsItem(null))
      .finally(() => setLoadingNews(false));
  }, []);

  const loading = loadingBlogs || loadingNews;

  // Nothing to show and nothing loading — don't render an empty section.
  if (!loading && blogs.length === 0 && !newsItem) return null;
    ...
    <section className="py-24 bg-white">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          {/* LEFT: Featured News & Event (big card) */}
          <div className="h-[400px]">
            ...
            {loadingNews ? (
              ...
              <div className="h-full rounded-2xl bg-gray-50 border border-gray-100 flex items-center justify-center text-gray-400 text-sm">
